...
public final class GearTransformer extends AbstractEnergyCrafter implements RecipeDisplayItem {
    ...
    protected void setup(@Nonnull BlockMenuPreset blockMenuPreset) {
        ...
        blockMenuPreset.drawBackground(new CustomItemStack(Material.BLUE_STAINED_GLASS_PANE, "&9放入工具"), new int[] {
                0, 1, 2,
                9, 11,
                18, 19, 20
        });
        blockMenuPreset.drawBackground(new CustomItemStack(Material.BLUE_STAINED_GLASS_PANE, "&9放入材料"), new int[] {
                6, 7, 8,
                15, 17,
                24, 25, 26
        });
    ...
    public void update(@Nonnull BlockMenu inv) {
        ...
        if (inputItem == null) { //no input
            ...
            inv.replaceExistingItem(STATUS_SLOT, new CustomItemStack(Material.BLUE_STAINED_GLASS_PANE, "&9左边放入工具/装备,右边放入材料"));
            return;
        ...
        if (inputToolType == null) { //invalid input
            ...
            inv.replaceExistingItem(STATUS_SLOT, new CustomItemStack(Material.BARRIER, "&c此物品不是工具/装备!"));
            return;
        ...
        inv.replaceExistingItem(STATUS_SLOT, new CustomItemStack(Material.LIME_STAINED_GLASS_PANE, "&a工具/装备改变了!"));
    }
